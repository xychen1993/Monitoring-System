...
<!--        <ul id="nav-mobile" class="right ">
    ...
    <div id = "contentWrapper">
      <div class="container">
        ...
        <div class="row">
          <form style="display: inline-block">
            <div id="max_frame"></div>
            Start Frame: <input type="text" id="start"><br>
            End Frame:   <input type="text" id="end">
            <br>
	  ...
	  <form action="#">
	   <p class="range-field">          
          ...
          <div id="output">Frame number: 1</div>
        </div></div>
        <div class="row">
    ...
    <script src="js/displaySkeleton.js"></script>
